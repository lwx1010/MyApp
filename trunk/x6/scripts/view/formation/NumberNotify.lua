--- 
-- 阵型位置变化浮动数值显示
-- @module view.formation.NumberNotify
-- 
...
local moduleName = "view.formation.NumberNotify"
module(moduleName)

---
-- 文本居中
-- @field [parent=#view.formation.NumberNotify] #string ALIGN_CENTER
-- 
ALIGN_CENTER = "ALIGN_CENTER"

---
-- 文本左对齐
-- @field [parent=#view.formation.NumberNotify] #string ALIGN_LEFT
-- 
ALIGN_LEFT = "ALIGN_LEFT"

---
-- 文本右对齐
-- @field [parent=#view.formation.NumberNotify] #string ALIGN_RIGHT
-- 
ALIGN_RIGHT = "ALIGN_RIGHT"

---
-- 最大提示数目
-- @field [parent=#view.formation.NumberNotify] #number MAX_NOTIFY
-- 
local MAX_NOTIFY = 6

---
-- 缩放时间
-- @field [parent=#view.formation.NumberNotify] #number SCALE_TIME
-- 
local SCALE_TIME = 0.2

---
-- 显示时间
-- @field [parent=#view.formation.NumberNotify] #number SHOW_TIME
-- 
local SHOW_TIME = 0.8

---
-- 消隐时间
-- @field [parent=#view.formation.NumberNotify] #number FADE_TIME
-- 
local FADE_TIME = 0.5

---
-- 边框宽度
-- @field [parent=#view.formation.NumberNotify] #number BORDER_WIDTH
-- 
local BORDER_WIDTH = 10

---
-- 垂直间距
-- @field [parent=#view.formation.NumberNotify] #number V_SPACE
-- 
local V_SPACE = 4

---
-- 显示的提示
-- @field [parent=#view.formation.NumberNotify] #table _showNotifies
-- 
local _showNotifies = {}

---
-- 空闲的提示
-- @field [parent=#view.formation.NumberNotify] #table _freeNotifies
-- 
local _freeNotifies = {}
...
---
-- 创建一个提示
-- @function [parent=#view.formation.NumberNotify] _createNotify
-- @return #NotifyUi
-- 
...
---
-- 显示一个提示
-- @function [parent=#view.formation.NumberNotify] show
...
--	notify.layer:changeWidthAndHeight(labSize.width+BORDER_WIDTH, labSize.height+BORDER_WIDTH)
	...
	elseif( align==ALIGN_LEFT ) then
		notify.spr:setPosition(showX-(labSize.width)*0.5, showY)
	else
		notify.spr:setPosition(showX+(labSize.width)*0.5, showY)
	end
    ...
    for i=1, #_showNotifies do
    	if( _showNotifies[i].showX==showX ) then
    		transition.moveBy(_showNotifies[i].spr, {time=SCALE_TIME, y=labSize.height+V_SPACE})
    	end
    end
