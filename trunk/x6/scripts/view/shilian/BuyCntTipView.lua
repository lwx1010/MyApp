--- 
-- 购买挑战至尊试炼次数提示界面
-- @module view.shilian.BuyCntTipView
-- 
...
local moduleName = "view.shilian.BuyCntTipView"
module(moduleName)
...
function BuyCntTipView:_okClkHandler( sender, event )
	...
	GameNet.send("C2s_shilian_buy_cnt", {buy_cnt = 1})
...
function BuyCntTipView:openUi( needYB )
	...
	self._needYB = needYB
	self["tipLab"]:setString(tr("确定花费<c1>") .. needYB .. tr("<c0>元宝购买挑战次数?"))
end
