...
void CCShapeNode::beforeDraw(void)
{
    ...
    ccDrawColor4F(m_lineColor.r, m_lineColor.g, m_lineColor.b, m_lineColor.a);
...
void CCRectShape::drawProc(void)
{
    ...
    if (m_fill)
    {
        ccDrawSolidRect(ccp(center.x - w, center.y + h), ccp(center.x + w, center.y - h), m_lineColor);
    }
    else
    {
        ccDrawColor4F(m_lineColor.r, m_lineColor.g, m_lineColor.b, m_lineColor.a);
...
void CCPolygonShape::drawProc(void)
{
    ...
    if (m_fill)
    {
        ccDrawSolidPoly(m_verticesDraw, m_numberOfVertices, m_lineColor);
    }
    else
    {
        ccDrawColor4F(m_lineColor.r, m_lineColor.g, m_lineColor.b, m_lineColor.a);
